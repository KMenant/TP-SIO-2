...
namespace BD_Déconnectée
{
    public class Modele
    {
        ...
        private DataView dv_etude = new DataView();
        ...
        {
            if (!connopen) return;
            mySqlDataAdapterTP7.SelectCommand = new MySqlCommand("select * from formation;select * from personne;select * from etude;", myConnection);
            try
            {
                dataSetTP7.Clear();
                ...
                dv_etude = dataSetTP7.Tables[2].DefaultView;
        ...
        public void info_formation(int id)
        {
            int IdPers = id;
            dv_etude.RowFilter = "(IdPersonne = "+IdPers+")";
        }
        ...
        public DataView Dv_etude //Accesseur DataView Etude
        {
            get { return dv_etude; }
            set { dv_etude = value; }
        }
