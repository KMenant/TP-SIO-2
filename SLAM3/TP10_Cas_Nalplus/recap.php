...
$email = '';
	...
	$pageRecap->corps .= '</br></br>RECAPITUALTIF : </br></br>';
	...
	$requete='INSERT INTO etudiant (email, mdp, nom, prenom, departement, pays, date_naiss, sexe, telephone,IdFormation, IdSpecialite, commentaire) 
			  VALUES (
			  	...
			  	"'.$IDconnexion->quote($_POST['pays']).'", 
			  	 ...
			  	 '.$IDconnexion->quote($_POST['maForm']).', 
			  	 '.$IDconnexion->quote($_POST['maSpe']).',
			  	"'.$IDconnexion->quote($_POST['comm']).'" );'; 
